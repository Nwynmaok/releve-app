    ...
    return (
      <View style={styles.container}>
          ...
          <View style={{flex:0.05, marginTop: 15, flexDirection: 'row', justifyContent: 'space-around' }}>
            <Text style={{fontSize: 16, color: '#535052'}}>Categories</Text>
            <Text style={{fontSize: 16, color: '#535052', fontWeight: 'bold'}}>Brand Commitment</Text>
          ...
          <View style={{flex:0.85, marginTop: 5, justifyContent: 'space-between'}}>
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                ...
                resizeMode="contain"
                source={require('../img/shop/Brand_Commitments/animal_free.png')}
              />
            </View>
            ...
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                style = {{flex:1 , width: undefined, height: undefined}}
                resizeMode="contain"
                source={require('../img/shop/Brand_Commitments/charitable.png')}
              />
            </View>
            ...
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                style = {{flex:1 , width: undefined, height: undefined}}
                resizeMode="contain"
                source={require('../img/shop/Brand_Commitments/fur_free.png')}
            />
            </View>
            ...
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                style = {{flex:1 , width: undefined, height: undefined}}
                resizeMode="contain"
                source={require('../img/shop/Brand_Commitments/hc_artisinal.png')}
              />
            </View>  
          </View>
      </View>
