    ...
    return (
      <View style={styles.container}>
          ...
          <View style={{flex:0.05, marginTop: 15, flexDirection: 'row', justifyContent: 'space-around' }}>
            ...
            <Text style={{fontSize: 16, color: '#535052',  fontWeight: 'bold'}}>Designers</Text>
          </View>
          ...
          <View style={{flex:0.85, marginTop: 5, justifyContent: 'space-between'}}>
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                ...
                resizeMode="contain"
                source={require('../img/shop/Designers/Abury.png')}
              />
            </View>
            ...
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                style = {{flex:1 , width: undefined, height: undefined}}
                resizeMode="contain"
                source={require('../img/shop/Designers/By_Sarah_London.png')}
              />
            </View>
            ...
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                style = {{flex:1 , width: undefined, height: undefined}}
                resizeMode="contain"
                source={require('../img/shop/Designers/Muzungu_Sisters.png')}
            />
            </View>
            ...
            <View style={{flex:0.25, marginHorizontal: 15, marginVertical: 5}}>
              <Image
                style = {{flex:1 , width: undefined, height: undefined}}
                resizeMode="contain"
                source={require('../img/shop/Designers/Oromai_London.png')}
              />
            </View>  
          </View>
      </View>
